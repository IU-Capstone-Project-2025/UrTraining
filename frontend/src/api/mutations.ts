...
import { signInRequest, signUpRequest } from "./apiRequests";
...
export const useSignUp = () => {
    return useMutation<SignUpSuccess, AxiosError<SignUpFailed>, CredentialsData>({
...
export const useSignIn = (authData: AuthCredentialsTokens) => {
    return useMutation<SignInSuccess, AxiosError<SignInFailed>, CredentialsData>({
