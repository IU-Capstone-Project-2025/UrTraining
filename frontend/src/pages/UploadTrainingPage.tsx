            ...
            <div>
                {step === "welcome" && (
                    <div className="centered-content">
                        ...
                        <div className="step-title-main">{t("upload_training.welcome")}</div>
                        <p>{t("upload_training.wel_desc")}</p>
                        <div className="button-group-welcome">
                            <button className="btn-basic-black" onClick={nextStep}>{t("upload_training.start")}</button>
                        </div>
                    </div>
                )}
                ...
                {step === "end" && (
                    <div className="centered-content">
                        <div className="step-title-main">{t("upload_training.success")}</div>
                        <p>{t("upload_training.suc_desc")}</p>
                        <div className="buttons">
                            <button onClick={() => navigate(`/course/${createdTrainingId}`)} className="btn-basic-black">
                                {t("upload_training.view")}
                            </button>
                            <button onClick={() => navigate('/')} className="btn-basic-white">
                                {t("upload_training.main")}
                            </button>
                        </div>
                    </div>
                )}
